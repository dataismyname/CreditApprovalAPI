...
--
-- Host: localhost    Database: prospectosdb
-- ------------------------------------------------------
...
CREATE TABLE `users` (
  ...
  `INGRESOS_MENSUALES` int DEFAULT NULL,
  `DEPENDIENTES` int DEFAULT NULL,
...
--
-- Dumping events for database 'prospectosdb'
--
...
-- Dump completed on 2022-12-10  0:27:43
